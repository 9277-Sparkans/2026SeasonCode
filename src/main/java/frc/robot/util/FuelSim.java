...
public class FuelSim {
    ...
    protected boolean simulateAirResistance = true;
    ...
    protected double loggingFreqHz = 100;
    ...
    public void launchFuel(LinearVelocity launchVelocity, Angle hoodAngle, Angle turretYaw, double spin, Transform3d robotToTurret) {
        ...
        Pose3d launchPose = new Pose3d(this.robotPoseSupplier.get()).plus(robotToTurret);
