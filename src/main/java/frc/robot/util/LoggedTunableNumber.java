 ...
 * default if not or value not in
 * dashboard.
 */
...
public class LoggedTunableNumber implements DoubleSupplier {
     ...
     *           between multiple objects. Recommended
     ...
     *                       when shared between multiple * objects. Recommended
     *                       approach is to pass the result of "hashCode()"
     * @param action         Callback to run when any of the tunable numbers have
     *                       changed. Access tunable numbers in order
     *                       inputted in method
