...
public class VisionConstants {
        ...
        public static double linearStdDevBaseline = 0.0001; // Meters (force trust in vision)
        public static double angularStdDevBaseline = 0.0001; // Radians (force trust in vision)
