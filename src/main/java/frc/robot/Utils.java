...
public class Utils {
    ...
    public static class Lookup {
        ...
        public double[] FindOptimalVals(double distance, double velocityX, double velocityY, double shooterRPM, double hoodAngle) { // Finds the optimal shot for minimum hood movement and RPM change
            ...
            double optimalWeight = minimumWeight / (2 * Constants.ShooterConstants.botVelocityWeight + Constants.ShooterConstants.shooterRPMWeight + Constants.ShooterConstants.hoodAngleWeight);
            return new double[]{optimalTurretOffset, optimalShooterRPM, optimalHoodAngle, optimalWeight};
        }
    }
